...
(function () {
    ...
    function Conversations(mountNode) {
        ...
        this.destroy = function () {
            _this.dialogsContainer.innerHTML = '';
            _this.messagesContainer.innerHTML = '';
            _this.chartForm.removeEventListener('submit', _this.dialogSelect);
            _this.dialogsContainer.removeEventListener('click', _this.dialogSelect);
            window.app.messagesObserver.unsubscribeAll();
            if (_this.activeRequest.cancel) _this.activeRequest.cancel();
        };
