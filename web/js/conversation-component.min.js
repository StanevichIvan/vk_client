...
(function () {
    ...
    function Conversations(mountNode) {
        ...
        this.newMessage = function (messages) {
            ...
            if (_this.messagesContainer.scrollTop === _this.messagesContainer.scrollHeight) {
        ...
        this.formSubmit = function (event) {
            ...
            vkService.sendMessage(this.userID, message).then(function () {
                _this2.messageInput.value = '';
            });
        }.bind(this);
        ...
        this.destroy = function () {
            ...
            if (this.activeRequest.cancel) this.activeRequest.cancel();
        }.bind(this);
    ...
    Conversations.prototype.showDialogs = function () {
        ...
        vkService.getDialogs(this.activeRequest).then(function (res) {
            _this3.renderDialogs(res);
        }).catch(function (err) {
            alert(err);
        });
    };
    ...
    Conversations.prototype.showUserMessages = function (uid) {
        ...
        vkService.getMessages(this.activeRequest, uid).then(function (messages) {
            _this4.messages = messages;
            _this4.renderMesasges(messages);
        });
    };
